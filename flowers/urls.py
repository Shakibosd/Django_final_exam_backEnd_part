...
from .views import FlowerViewSet, FlowerDetail, CommentViewSet, CommentAPIView, CommentShowAPIView, CheckOrderView, admin_dashboard
...
urlpatterns = [
    ...
    path('check_order/', CheckOrderView.as_view(), name='check_order'),
