...
from .views import FlowerViewSet, FlowerDetail, CommentViewSet, CommentAPIView, CommentShowAPIView, CheckOrder
...
urlpatterns = [
    ...
    path('check_order/', CheckOrder.as_view(), name='check_order'),
]